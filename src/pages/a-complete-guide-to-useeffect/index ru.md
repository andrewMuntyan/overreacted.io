...
**Только после того, как я перестал смотерть на `useEffect` Хук через призму известных мне методов жизненного цикла компонента, картинка в голове сложилась окончательно**

>“Забудь все то, чему тебя учили.” — Yoda

![Йода принюхивается к запаху воздуха. Подпись: “Я чую I smell бекон.”](./yoda.jpg)

---

**Эта статья предполагает наличие у вас навыков использования [`useEffect`](https://reactjs.org/docs/hooks-effect.html) API.**
